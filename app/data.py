...
NAME_FAMILY_STATUS_rus = [
    "Холост/не в браке", "Женат/замужем", "Гражданский брак", "Разведен/разведена", "Вдовец/вдова"
]
...
NAME_HOUSING_TYPE_rus = [
    "Дом/квартира", "С родителями", "Муниципальная квартира",
...
ORGANIZATION_TYPE_rus = [
    "Бизнес", "Школа", "Правительство", "Религия", "Электричество", "Медицина",
    "Самозанятые", "Транспорт", "Строительство", "Жилье", "Детский сад", "Торговля",
    "Промышленность", "Военные", "Услуги", "Министерства безопасности", "Экстренная служба",
    ...
    "Реклама", "Клининг", "Телеком", "Риэлтор", "Другое"
]
